...
conhecidas por ele e que também foram observadas pelo seu par, e ainda 
...
No entanto, para que um robô incorpore os mapas (grade e \textit{landmarks}) do outro aos seus prórpios, é necessário antes que se determine a posição relativa entre eles para transformar os 
...
A exposição que segue abaixo nessa Seção é inspirada em \cite[Seção~12.11]{bongard2006probabilistic}. 
...
O vetor e a matriz de informação aumentados é simplesmente o vetor e matriz do robô $k$ concatenados com o 
