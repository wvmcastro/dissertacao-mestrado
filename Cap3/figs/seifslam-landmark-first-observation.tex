...
\begin{tikzpicture}
  ...
  \def\activeLandmarks{\landmark1}
  \def\passiveLandmarks{\landmark2, \landmark3}
  ...
  % arcs
  \path[latex-latex, thick, bend left] (1.5,\m-0.5) edge node [pos=.7, anchor=south, sloped] {conexão} (L_1);
