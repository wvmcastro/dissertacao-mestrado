...
\begin{figure}[]
  ...
  \caption{Em azul, os conjuntos de pontos selecionados como pertencentes às superfícies das \textit{landmarks}. Em verde, os círculos 
...
forma do logaritmo da razão de chances (\textit{log odds ratio}) \cite[p.~94]{bongard2006probabilistic}. A razão de chances é a 
