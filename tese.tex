...
\begin{itadedication}
Aos amigos da Graduação e Pós-Graduação do ITA.
\end{itadedication}
...
\chapter{Aplicação da estimação no problema SLAM (\textit{Backend})}
\import{Cap3/}{cap3}

\chapter{SLAM \textit{Frontend}}
\import{CapX/}{capx}
...
\chapter{Manipulações da distribuição de probabilidade gaussiana 
multivariada na forma canônica}
\label{app:info-gaussian-manipulation}
\import{ApeC/}{probabilistic-distribution-manipulation}
